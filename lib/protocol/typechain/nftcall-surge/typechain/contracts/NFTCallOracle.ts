...
export interface NFTCallOracleInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "PRICE_UNIT",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "VOL_DECIMALS",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    ...
    values: [
      ...
      NFTCallOracle.UpdateInputStruct[][]
    ]
  ): string;
  encodeFunctionData(
...
export type ReplaceAssetEvent = TypedEvent<
  [string, string],
  ReplaceAssetEventObject
>;
...
export type SetEmergencyAdminEvent = TypedEvent<
  [string, boolean],
  SetEmergencyAdminEventObject
>;

export type SetEmergencyAdminEventFilter =
  TypedEventFilter<SetEmergencyAdminEvent>;
...
export interface NFTCallOracle extends BaseContract {
  ...
  functions: {
    ...
    getIndexes(
      ...
      [BigNumber, BigNumber] & { OuterIndex: BigNumber; InnerIndex: BigNumber }
    >;
  ...
  filters: {
    ...
    "SetAssetData(uint256[],tuple[][])"(
      indexes?: null,
      inputs?: null
    ): SetAssetDataEventFilter;
