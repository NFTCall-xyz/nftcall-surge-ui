...
export interface MintableERC20Interface extends utils.Interface {
  functions: {
    ...
    'setMaxMintAmountPerUser(uint256)': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'ownerMint', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'renounceOwnership', values?: undefined): string
  encodeFunctionData(functionFragment: 'setMaxMintAmountPerUser', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'setWhitelistAddress', values: [string, boolean]): string
  ...
  decodeFunctionResult(functionFragment: 'setMaxMintAmountPerUser', data: BytesLike): Result
...
export interface MintableERC20 extends BaseContract {
  ...
  callStatic: {
    ...
    ownerMint(to: string, mintAmount: BigNumberish, overrides?: CallOverrides): Promise<void>

    renounceOwnership(overrides?: CallOverrides): Promise<void>

    setMaxMintAmountPerUser(maxMintAmount: BigNumberish, overrides?: CallOverrides): Promise<void>

    setWhitelistAddress(account: string, whitelisted: boolean, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    ownerMint(to: string, mintAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>

    renounceOwnership(overrides?: Overrides & { from?: string }): Promise<BigNumber>

    setMaxMintAmountPerUser(maxMintAmount: BigNumberish, overrides?: Overrides & { from?: string }): Promise<BigNumber>
