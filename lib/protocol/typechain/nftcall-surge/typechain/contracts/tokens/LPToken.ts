...
export interface LPTokenInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "MAXIMUM_WITHDRAW_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "WITHDRAW_FEE_RATIO",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "maximumVaultBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setMaximumVaultBalance",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "setMinimumAssetToShareRatio",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  ...
  getEvent(
    nameOrSignatureOrTopic: "UpdateMinimumAssetToShareRatio"
  ): EventFragment;
...
export type UpdateMaximumVaultBalanceEvent = TypedEvent<
  [BigNumber],
  UpdateMaximumVaultBalanceEventObject
>;

export type UpdateMaximumVaultBalanceEventFilter =
  TypedEventFilter<UpdateMaximumVaultBalanceEvent>;

export interface UpdateMinimumAssetToShareRatioEventObject {
  ratio: BigNumber;
}
export type UpdateMinimumAssetToShareRatioEvent = TypedEvent<
  [BigNumber],
  UpdateMinimumAssetToShareRatioEventObject
>;

export type UpdateMinimumAssetToShareRatioEventFilter =
  TypedEventFilter<UpdateMinimumAssetToShareRatioEvent>;
...
export interface LPToken extends BaseContract {
  ...
  filters: {
    ...
    "UpdateMaximumVaultBalance(uint256)"(
      maxVaultBalance?: null
    ): UpdateMaximumVaultBalanceEventFilter;
    UpdateMaximumVaultBalance(
      maxVaultBalance?: null
    ): UpdateMaximumVaultBalanceEventFilter;

    "UpdateMinimumAssetToShareRatio(uint256)"(
      ratio?: null
    ): UpdateMinimumAssetToShareRatioEventFilter;
    UpdateMinimumAssetToShareRatio(
      ratio?: null
    ): UpdateMinimumAssetToShareRatioEventFilter;
